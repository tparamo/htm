...
control = {
  ...
  'dataset' : {   'aggregation': config['aggregationInfo'],
        ...
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'data.csv',
                            u'last_record': 100,
                            u'source': u'file://Datos\data.csv'}],
        u'version': 1},
 ...
 u'predictedField': u'VAR',
 u'predictionSteps': [1]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'VAR', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'aae'}),
    MetricSpec(field=u'VAR', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'altMAPE'})
  ],
